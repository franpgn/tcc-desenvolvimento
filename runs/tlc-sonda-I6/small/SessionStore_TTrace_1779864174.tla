---- MODULE SessionStore_TTrace_1779864174 ----
...
_inv ==
    ~(
        ...
        /\
        contador = ((r1 :> (u1 :> 2 @@ u2 :> 0) @@ r2 :> (u1 :> 0 @@ u2 :> 0)))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SessionStore_TTrace_1779864174.json", _TETrace)
...
\*
\*trace == IODeserialize("SessionStore_TTrace_1779864174.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([contador |-> (r1 :> (u1 :> 1 @@ u2 :> 0) @@ r2 :> (u1 :> 0 @@ u2 :> 0)),motivos |-> (r1 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE") @@ r2 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE")),sessoes |-> (r1 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE") @@ r2 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE")),canal |-> <<[tipo |-> "CONTADOR_INC", chave |-> u1, payload |-> ""]>>,sessaoDe |-> (r1 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE") @@ r2 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE")),status |-> (r1 :> (u1 :> "OPEN" @@ u2 :> "OPEN") @@ r2 :> (u1 :> "OPEN" @@ u2 :> "OPEN"))]),
    ([contador |-> (r1 :> (u1 :> 2 @@ u2 :> 0) @@ r2 :> (u1 :> 0 @@ u2 :> 0)),motivos |-> (r1 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE") @@ r2 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE")),sessoes |-> (r1 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE") @@ r2 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE")),canal |-> <<>>,sessaoDe |-> (r1 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE") @@ r2 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE")),status |-> (r1 :> (u1 :> "OPEN" @@ u2 :> "OPEN") @@ r2 :> (u1 :> "OPEN" @@ u2 :> "OPEN"))])
    >>
----
...
---- CONFIG SessionStore_TTrace_1779864174 ----
CONSTANTS
    IDS = { u1 , u2 }
    SIDS = { s1 , s2 , s3 }
    REPLICAS = { r1 , r2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue May 26 23:42:55 PDT 2026