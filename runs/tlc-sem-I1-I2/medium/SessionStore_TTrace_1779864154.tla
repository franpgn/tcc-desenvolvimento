---- MODULE SessionStore_TTrace_1779864154 ----
...
_inv ==
    ~(
        ...
        /\
        sessoes = ((r1 :> (s1 :> "VALID" @@ s2 :> "NONE" @@ s3 :> "NONE") @@ r2 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE")))
        /\
        canal = (<<>>)
        /\
        sessaoDe = ((r1 :> (s1 :> u1 @@ s2 :> "NONE" @@ s3 :> "NONE") @@ r2 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE")))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SessionStore_TTrace_1779864154.json", _TETrace)
...
\*
\*trace == IODeserialize("SessionStore_TTrace_1779864154.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([contador |-> (r1 :> (u1 :> 0 @@ u2 :> 0 @@ u3 :> 0) @@ r2 :> (u1 :> 0 @@ u2 :> 0 @@ u3 :> 0)),motivos |-> (r1 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE") @@ r2 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE")),sessoes |-> (r1 :> (s1 :> "VALID" @@ s2 :> "NONE" @@ s3 :> "NONE") @@ r2 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE")),canal |-> <<>>,sessaoDe |-> (r1 :> (s1 :> u1 @@ s2 :> "NONE" @@ s3 :> "NONE") @@ r2 :> (s1 :> "NONE" @@ s2 :> "NONE" @@ s3 :> "NONE")),status |-> (r1 :> (u1 :> "OPEN" @@ u2 :> "OPEN" @@ u3 :> "OPEN") @@ r2 :> (u1 :> "OPEN" @@ u2 :> "OPEN" @@ u3 :> "OPEN"))])
    >>
----
...
---- CONFIG SessionStore_TTrace_1779864154 ----
CONSTANTS
    IDS = { u1 , u2 , u3 }
    SIDS = { s1 , s2 , s3 }
    REPLICAS = { r1 , r2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue May 26 23:42:35 PDT 2026